...
export const HUBS = [
  ...
  { id: 'dc', x: 0.814, y: 0.404, label: 'AP News', ldx: 10, ldy: 26, align: 'left' },
  { id: 'chi', x: 0.634, y: 0.284, label: 'StreetInsider', ldx: -12, ldy: -18, align: 'right' },
  { id: 'dfw', x: 0.478, y: 0.648, label: 'AIWire', ldx: -12, ldy: 14, align: 'right' },
