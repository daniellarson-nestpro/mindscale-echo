...
/** Where a visitor with nothing to pay for goes. Stripe never opens first. */
export const START_PATH = '/start';

/**
 * Where /checkout should send the visitor instead of rendering, or null to
 * render. Nobody reaches Stripe without an approved draft: an anonymous
 * visitor goes to /start, a resolved lead with no draft back to the brief,
