 ...
 *
 * draftFromBrief maps a saved lead into this shape (no n8n). DEMO_DRAFT is
 * last-resort only: unauthenticated `/preview/demo` with no lead.
 */
...
/**
 * Map a saved lead/brief into the DEMO_DRAFT shape without calling n8n.
