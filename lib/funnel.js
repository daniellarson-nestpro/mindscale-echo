...
export const STEP_ARTICLE = {
  ...
  sub: 'Paste the link to your article and we’ll take it from there.',
  label: 'Link to your write-up',
  placeholder: 'heraldtribune.com/business/sals-pizza-third-street',
  hint: 'Newspaper, local TV, a blog, a neighborhood newsletter — anything counts.',
  dropHint: 'Paste a link, drop the PDF, or paste the whole article — whatever you have.',
  parseFail:
    'We couldn’t open that link. You can paste the article text instead, or just keep going and send it to us later.',
  parsePartial: 'We couldn’t read it automatically; a person will.',
  ambiguous: 'Is that a link? Add the rest of it, or paste the whole article.',
...
export const FIELDS = {
  ...
  logo: {
    ...
    wrongType: 'We need an image file — PNG, JPG, or SVG.',
    replace: 'Change it',
  },
  contactName: {
  ...
  additionalQuote: {
    add: 'Add another voice',
    addHint: 'Co-owner, partner, your GM — anyone else who should be quoted.',
    label: (n) => `Quote ${n}`,
    quoteLabel: 'What do they want to say?',
    quotePlaceholder:
      'My brother runs the kitchen. He’s been waiting years for an oven that size.',
    attributionLabel: 'Who’s saying it?',
    attributionPlaceholder: 'Maria Marino, Co-owner',
    remove: 'Remove',
    /**
     * Honest craft advice rather than a hard stop: editors trim padded
     * releases, and two or three voices is what a real one carries.
     */
    plenty: 'Two or three voices is plenty — past that, editors start trimming.',
  },
};

/** Soft ceiling on quotes. The UI stops offering more; nothing breaks. */
